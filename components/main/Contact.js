  ...
  return (
    <section id="contact" className={style.contact}>
        ...
        {showSuccessMessage && <>
            ...
            <div className={style.successMessage}>
                {/* <div className={style.successMessage__icon}>&#10004;</div> */}
                <h3>Spicx, c&apos;est terminé...</h3>
                <p>L&apos;agence Spicx n&apos;existe plus depuis décembre 2022.
                <br/>Vous pouvez me contacter à l&apos;adresse suivante : loic.lecolier@gmail.com.</p>
                <button className="btnPrimary" onClick={() => setShowSuccessMessage(false)}>Fermer</button>
            </div>
        </> }
    </section>
