...
export default function CreationSiteWeb() {
  return (
    <>
      <Head>
          <title>Spicx - Création de site web</title>
          <meta name="description" content="Faites confiance à Spicx pour développer votre site. Notre flexibilité nous permet d’utiliser les bons outils en fonction de vos besoins et votre budget" />
      </Head>
      <Hero
